...
export default function BookingWizard({ prefillVan = '', prefillNaar = '' }) {
  const [step, setStep] = useState(1)
  const [form, setForm] = useState({ ...empty, ophaal: prefillVan, bestemming: prefillNaar })
    ...
    <div className="max-w-2xl mx-auto">
      ...
      {step === 2 && (
        <div className="bg-white border border-gray-100 rounded-3xl shadow-lg shadow-gray-100 p-5 sm:p-8">
          <h3 className="text-lg font-bold text-gray-900 mb-1">Kies je voertuig</h3>
      ...
      {step === 3 && (
        <form onSubmit={submit} className="bg-white border border-gray-100 rounded-3xl shadow-lg shadow-gray-100 p-5 sm:p-8 space-y-5">
          <h3 className="text-lg font-bold text-gray-900">Jouw gegevens</h3>
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-3xl shadow-lg shadow-gray-100 p-5 sm:p-8">
      <div className="text-center mb-6">
        ...
        <h3 className="text-2xl font-bold text-gray-900">Bedankt, {b.naam}!</h3>
      ...
      <button onClick={onReset} className="w-full text-gray-500 hover:text-amber-600 text-sm font-medium">Nieuwe rit boeken</button>

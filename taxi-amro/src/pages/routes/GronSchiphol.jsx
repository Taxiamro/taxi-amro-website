...
const route = {
  ...
  body: [
    ...
    <p style="margin-top:0.75rem;">Uber en Bolt zijn op die tijdstippen in Groningen nauwelijks beschikbaar. En als er al een auto is, kan surge pricing oplopen tot €400–500 — terwijl u bij ons altijd €491 betaalt.</p>`,
    ...
    <p>Het officiële metertarief (€4,31 start + €3,17/km) zou op 205 km uitkomen op <strong>€654</strong>. Taxi Amro rekent <strong>€491 vast</strong> — 25% goedkoper. De trein kost €30–50 p.p. maar met overstappen en koffers slepen duurt het 3+ uur. P-long parkeren bij Schiphol kost €12–18 per dag. Bij een week weg is dat al €84–126 extra.</p>`,
  ],
  faqs: [
    ...
    { q: 'Hoeveel koffers passen er mee?', a: 'Onze Hyundai Nexo heeft een ruime kofferbak. Standaard passen 2–3 grote koffers + handbagage. Meer bagage? Bel ons even.' },

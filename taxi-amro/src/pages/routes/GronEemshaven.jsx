...
const route = {
  ...
  body: [
    ...
    <p>De AG EMS veerboot vertrekt meerdere keren per dag vanuit Eemshaven naar Borkum. De overtocht duurt ±2,5 uur. Wij brengen u met koffers en al rechtstreeks naar de veerterminal. Geen parkeerkosten (Eemshaven parkeren kan €8–12/dag kosten per week dat is al snel €60+), geen rij bij de bus.</p>`,

...
const route = {
  ...
  compareRows: [
    ...
    ['Geen parkeerkosten haven', '✅ Bespaart €8 tot €12/dag', '—'],
  ...
  body: [
    ...
    <p>Wie met de eigen auto gaat, betaalt al snel €8 tot €12 per dag parkeren bij Holwerd, bij een weekje weg loopt dat flink op. Wij zetten u met koffers en al af bij de terminal, zodat u zorgeloos op de boot stapt.</p>`,

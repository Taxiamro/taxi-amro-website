...
const route = {
  ...
  body: [
    ...
    <p>Veel budgetvluchten vanaf Eindhoven vertrekken rond 06:00–07:00. Met ±2u50 reistijd betekent dat ophalen in Groningen rond 02:30–03:00. Taxi Amro is 24/7 beschikbaar, <strong>zonder nachttoeslag</strong>. Terwijl Uber en Bolt op die tijden in Groningen nauwelijks rijden, staan wij gewoon voor uw deur.</p>`,
    ...
    <p>Met de trein bent u vanuit Groningen 3,5–4 uur onderweg met twee overstappen (Zwolle, Eindhoven Centraal + bus 401). Parkeren bij Eindhoven Airport kost €30–80 voor een weekend. Bij een vaste prijs van <strong>€645</strong> reist u met 2 tot 4 personen vaak voordeliger én comfortabeler — van deur tot deur.</p>`,
  ],
  faqs: [
    ...
    { q: 'Hoeveel personen en koffers kunnen mee?', a: 'Tot 4 personen met een ruime kofferbak (2–3 grote koffers + handbagage). Meer bagage? Bel ons even.' },
    { q: 'Is een taxi goedkoper dan parkeren?', a: 'Bij 2 of meer personen of een langere reis vaak wel. U betaalt geen €30–80 parkeerkosten en reist van deur tot deur.' },
  ],
  relatedRoutes: [

              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    { route: 'Groningen → Drachten', icon: '📍', afstand: '~40 km', meter: '€131', vast: '€105', besparing: '20%', slug: '/taxi-groningen-drachten' },
                    ...
                    { route: 'Groningen → Amsterdam', icon: '🏙️', afstand: '~185 km', meter: '€560', vast: '€445', besparing: '20%', slug: '/taxi-groningen-amsterdam' },
                    { route: 'Groningen → Zwolle', icon: '🚉', afstand: '~105 km', meter: '€320', vast: '€255', besparing: '20%', slug: '/taxi-groningen-zwolle' },
                    { route: 'Groningen → Heerenveen', icon: '⛸️', afstand: '~62 km', meter: '€195', vast: '€155', besparing: '20%', slug: '/taxi-groningen-heerenveen' },
                    { route: 'Groningen → Emmen', icon: '🦒', afstand: '~57 km', meter: '€188', vast: '€150', besparing: '20%', slug: '/taxi-groningen-emmen' },
                    { route: 'Groningen → Winschoten', icon: '📍', afstand: '~38 km', meter: '€131', vast: '€105', besparing: '20%', slug: '/taxi-groningen-winschoten' },
                    { route: 'Groningen → Delfzijl', icon: '⚓', afstand: '~30 km', meter: '€112', vast: '€90', besparing: '20%', slug: '/taxi-groningen-delfzijl' },
                    { route: 'Groningen → Holwerd (boot Ameland)', icon: '⛴️', afstand: '~55 km', meter: '€180', vast: '€145', besparing: '19%', slug: '/taxi-groningen-holwerd' },
